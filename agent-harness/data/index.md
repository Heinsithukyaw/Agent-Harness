...
Generated from `data/projects.json` on 2026-09-26T08:55:12.308Z.
...
| --- | ---: | --- | --- | --- |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | 82,989 | Python | GitHub Actions | An open-source long-horizon SuperAgent harness that researches, codes, and creates. With… |
| [stablyai/orca](https://github.com/stablyai/orca) | 78,546 | TypeScript | GitHub Actions, React | Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with yo… |
| [microsoft/ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners) | 75,696 | Python | GitHub Actions | 18 Lessons to Get Started Building AI Agents |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 73,298 | TypeScript | Express, GitHub Actions | 🌊 The original agent harness. Deploy intelligent multi-player swarms, coordinate autonom… |
| [microsoft/autogen](https://github.com/microsoft/autogen) | 61,171 | Python | GitHub Actions | A programming framework for agentic AI |
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | 59,041 | Python | FastAPI, GitHub Actions, LangChain, PyTorch | Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborativ… |
| [rohitg00/ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) | 57,791 | Python | GitHub Actions | Learn it. Build it. Ship it for others. |
| [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | 48,583 | Python | Docker, Docker Compose, GitHub Actions, Pydantic | Ultra-lightweight, open-source, self-hosted personal AI agent framework in Python with We… |
| [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) | 47,123 | Python | Docker, GitHub Actions | Open-source super AI assistant &amp; Agent Harness. Plans tasks, runs tools and skills, self-… |
| [666ghj/BettaFish](https://github.com/666ghj/BettaFish) | 42,294 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | 微舆：人人可用的多Agent舆情分析助手，打破信息茧房，还原舆情原貌，预测未来走向，辅助决策！从0实现，不依赖任何框架。 |
...
| [herdrdev/herdr](https://github.com/herdrdev/herdr) | 40,809 | Rust | GitHub Actions, Tokio | the runtime your coding agents live on |
...
| [HKUDS/Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) | 34,055 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | &quot;Vibe-Trading: Your Personal Trading Agent&quot; |
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | 32,384 | Python | FastAPI, GitHub Actions | Build and run agents you can see, understand and trust. |
| [langchain-ai/deepagents](https://github.com/langchain-ai/deepagents) | 29,776 | Python | GitHub Actions | The batteries-included agent harness. |
| [vxcontrol/pentagi](https://github.com/vxcontrol/pentagi) | 24,973 | Go | Docker, Docker Compose, GitHub Actions | Fully autonomous AI Agents system capable of performing complex penetration testing tasks |
| [NirDiamant/GenAI_Agents](https://github.com/NirDiamant/GenAI_Agents) | 24,386 | Python | LangChain, LangGraph | 50+ tutorials and implementations for Generative AI Agent techniques, from basic conversa… |
| [google/adk-python](https://github.com/google/adk-python) | 21,647 | Python | FastAPI, GitHub Actions, LangChain, LangGraph | An open-source, code-first Python toolkit for building, evaluating, and deploying sophist… |
...
| [jnMetaCode/agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh) | 20,946 | PowerShell | GitHub Actions | 🎭 277 个即插即用的 AI 专家角色 — 支持 Claude Code/Cursor/Copilot 等 20 种工具，覆盖工程/设计/营销/金融等 20 个部门。含 64… |
| [rowboatlabs/rowboat](https://github.com/rowboatlabs/rowboat) | 17,969 | TypeScript | GitHub Actions | AI coworker with memory and collaboration |
| [cft0808/edict](https://github.com/cft0808/edict) | 16,913 | Python | Docker, Docker Compose, GitHub Actions | 🏛️ 三省六部制 · OpenClaw Multi-Agent Orchestration System — 9 specialized AI agents with real… |
| [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) | 16,649 | Python | GitHub Actions | &quot;DeepCode: Open Agentic Coding (Agent Harness &amp; Loop Engineering &amp; Multi-Agent Orchestrat… |
| [triggerdotdev/trigger.dev](https://github.com/triggerdotdev/trigger.dev) | 16,414 | TypeScript | GitHub Actions | Trigger.dev – build and deploy durable AI agents and workflows |
| [eigent-ai/eigent](https://github.com/eigent-ai/eigent) | 15,425 | TypeScript | GitHub Actions, React | Eigent: The Open Source Cowork Desktop - Local and Free Alternative to Claude Cowork and… |
| [superset-sh/superset](https://github.com/superset-sh/superset) | 14,652 | TypeScript | Docker Compose, GitHub Actions, Next.js | Superset is an agentic IDE to orchestrate 100+ coding agents in parallel. Run any agent w… |
| [aiming-lab/AutoResearchClaw](https://github.com/aiming-lab/AutoResearchClaw) | 14,529 | Python | — | Fully autonomous &amp; self-evolving research from idea to paper. Chat an Idea. Get a Paper.… |
| [nanobrowser/nanobrowser](https://github.com/nanobrowser/nanobrowser) | 13,831 | TypeScript | React | Open-Source Chrome extension for AI-powered web automation. Run multi-agent workflows usi… |
| [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | 13,804 | Python | GitHub Actions | A framework for building, orchestrating and deploying AI agents and multi-agent workflows… |
| [Untrivial-ai/agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator) | 12,394 | Go | GitHub Actions | Run and supervise teams of coding agents from planning to merge. Any harness (Claude code… |
...
| [EKKOLearnAI/ekko-studio](https://github.com/EKKOLearnAI/ekko-studio) | 11,191 | TypeScript | Docker, Docker Compose, GitHub Actions | Ekko Studio is a local-first AI workspace for multi-agent chat, coding, and visual workfl… |
...
| [VoltAgent/voltagent](https://github.com/VoltAgent/voltagent) | 10,676 | TypeScript | GitHub Actions | AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework |
| [omnigent-ai/omnigent](https://github.com/omnigent-ai/omnigent) | 10,249 | Python | FastAPI, GitHub Actions, Pydantic | Omnigent is an open-source AI agent framework and meta-harness: orchestrate Claude Code,… |
| [adongwanai/AgentGuide](https://github.com/adongwanai/AgentGuide) | 10,097 | MDX | GitHub Actions | https://adongwanai.github.io/AgentGuide \| AI Agent开发指南 \| LangGraph实战 \| 高级RAG \| 转行大模型… |
...
| [iflytek/astron-agent](https://github.com/iflytek/astron-agent) | 9,048 | Java | GitHub Actions | Enterprise-grade, commercial-friendly agentic workflow platform for building next-generat… |
| [Nasiko-Labs/nasiko](https://github.com/Nasiko-Labs/nasiko) | 8,912 | Rust | Docker Compose, GitHub Actions, Tokio | Developer Control Plane for your AI Agents |
| [strands-agents/harness-sdk](https://github.com/strands-agents/harness-sdk) | 8,432 | Python | GitHub Actions | Build an agent harness and control it end-to-end. Open-source SDK for production AI agent… |
| [chaitanyagiri/munder-difflin](https://github.com/chaitanyagiri/munder-difflin) | 7,963 | TypeScript | GitHub Actions, React | A local multi-agent harness that works with your existing Claude Code, Codex subscription… |
...
| [flyteorg/flyte](https://github.com/flyteorg/flyte) | 7,574 | Go | Docker, GitHub Actions, gRPC | Dynamic, resilient AI orchestration. Coordinate data, models, and compute as you build AI… |
| [xerrors/Yuxi](https://github.com/xerrors/Yuxi) | 7,213 | Python | Docker Compose, GitHub Actions | 可私有部署的多租户知识智能体平台：统一 RAG、知识图谱、多智能体、MCP/Skills、沙盒与权限管理。Yuxi = Cloud Agents + Knowledge RAG,… |
| [kyegomez/swarms](https://github.com/kyegomez/swarms) | 7,207 | Python | GitHub Actions, Pydantic | The Enterprise-Grade Multi-Agent Orchestration Framework. Website: https://swarms.ai |
| [WenyuChiou/awesome-agentic-ai-zh](https://github.com/WenyuChiou/awesome-agentic-ai-zh) | 7,182 | Python | GitHub Actions | A trilingual (繁中 / English / 简中) learning roadmap for agentic AI: from LLM basics to mult… |
...
| [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) | 6,736 | TypeScript | GitHub Actions | Enterprise-grade, local-first Agent Workbench for people and agent teams. A unified multi… |
| [j3ssie/osmedeus](https://github.com/j3ssie/osmedeus) | 6,579 | Go | GitHub Actions, gRPC | A Modern Orchestration Engine for Security |
| [spinabot/brigade](https://github.com/spinabot/brigade) | 6,573 | TypeScript | GitHub Actions | Brigade — Your personal intelligence, built enterprise-grade |
...
| [builderz-labs/mission-control](https://github.com/builderz-labs/mission-control) | 6,271 | TypeScript | Docker, Docker Compose, GitHub Actions, Next.js | Self-hosted control plane for AI agents: dispatch tasks, review runs, track spend, and op… |
| [loopx-project/loopx](https://github.com/loopx-project/loopx) | 6,001 | Python | GitHub Actions, TypeScript | A control plane with a durable state kernel for long-horizon agents and teams. Keep work… |
...
| [Waishnav/devspace](https://github.com/Waishnav/devspace) | 5,131 | TypeScript | Express, GitHub Actions, MCP SDK, React | Minimal Coding Agent Harness on MCP for ChatGPT, Claude, Hermes, Grok Bot, OpenClaw |
...
| [didilili/ai-agents-from-zero](https://github.com/didilili/ai-agents-from-zero) | 4,914 | Python | LangChain, LangGraph | 🚀 2026 最系统的 AI Agent 速成指南｜智能体实战教程 · 完整学习路径  + 实战项目 + 面试题库 · 对标大模型应用开发工程师岗位 · 覆盖LangChain… |
...
| [ApodexAI/FrontierAgent](https://github.com/ApodexAI/FrontierAgent) | 4,617 | Python | Docker, GitHub Actions, Pydantic | 🧩 FrontierAgent, our agent framework, open-sourced alongside it — native command-line TU… |
...
| [ai-boost/awesome-harness-engineering](https://github.com/ai-boost/awesome-harness-engineering) | 4,531 | Python | — | Awesome list for AI agent harness engineering: tools, patterns, evals, memory, MCP, permi… |
...
| [0xNyk/council-of-high-intelligence](https://github.com/0xNyk/council-of-high-intelligence) | 4,511 | Python | GitHub Actions | Structured multi-perspective deliberation for hard decisions. Run full councils, focused… |
...
| [dagucloud/dagu](https://github.com/dagucloud/dagu) | 4,102 | Go | Docker, GitHub Actions, gRPC | Self-hostable workflow orchestrator for teams whose main work isn&#39;t orchestration. Declar… |
| [nyldn/claude-octopus](https://github.com/nyldn/claude-octopus) | 4,100 | TypeScript | GitHub Actions | Run multiple AI models against the same research, design, or coding task. Surface disagre… |
| [EverMind-AI/Raven](https://github.com/EverMind-AI/Raven) | 4,077 | Python | Docker, GitHub Actions, Pydantic | The Harness of Harnesses: a trusted, persistent, self-evolving multi-agent ecosystem for… |
...
| [tutti-os/tutti](https://github.com/tutti-os/tutti) | 3,784 | TypeScript | GitHub Actions | Where people and agents build in tune. |
...
| [code-yeongyu/lazycodex](https://github.com/code-yeongyu/lazycodex) | 3,643 | TypeScript | GitHub Actions | The one and only agent harness for complex codebases. Project memory, planning, execution… |
| [nextlevelbuilder/goclaw](https://github.com/nextlevelbuilder/goclaw) | 3,618 | Go | Docker, Docker Compose, GitHub Actions, gRPC | GoClaw - GoClaw is OpenClaw rebuilt in Go — with multi-tenant isolation, 5-layer security… |
| [foryourhealth111-pixel/Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3,452 | Python | GitHub Actions | Intelligent Skill routing and workflow orchestration for AI agents — +21.12 pp reward, −2… |
...
| [wquguru/harness-books](https://github.com/wquguru/harness-books) | 3,142 | Python | GitHub Actions | 📚 Two books on harness engineering — the design philosophies behind Claude Code &amp; Codex:… |
...
| [MaxMiksa/Auto-Company](https://github.com/MaxMiksa/Auto-Company) | 3,103 | Python | GitHub Actions | An auto-company works for 24/7 on your own PC - Windows/Linux/macOS. |
| [rohitg00/pro-workflow](https://github.com/rohitg00/pro-workflow) | 2,883 | JavaScript | GitHub Actions, TypeScript | Claude Code learns from your corrections: self-correcting memory that compounds over 50+… |
...
| [Agent-Field/agentfield](https://github.com/Agent-Field/agentfield) | 2,582 | Go | GitHub Actions | Build, run and scale AI agents like API and microservices |
| [datawhalechina/deepagents-in-action](https://github.com/datawhalechina/deepagents-in-action) | 2,521 | Astro | GitHub Actions | 📚 《Deep Agents 实战》—— LangChain 官方大使出品，基于 LangChain / LangGraph 生态，从零构建生产级 AI Agent 的完整指南 |
...
| [Prism-Shadow/penguin-harness](https://github.com/Prism-Shadow/penguin-harness) | 2,387 | TypeScript | Docker, GitHub Actions | 🐧 Harness for RSI. Let AI Build AI. Multi-Agent Auto-Dev Platform. Everything is Transpa… |
| [llmsresearch/paperbanana](https://github.com/llmsresearch/paperbanana) | 2,383 | Python | Docker, GitHub Actions, Pydantic | Open source implementation and extension of Google Research’s PaperBanana for automated a… |
...
| [jnMetaCode/agency-orchestrator](https://github.com/jnMetaCode/agency-orchestrator) | 2,299 | TypeScript | Docker, Docker Compose, Express, GitHub Actions | 🚀 One sentence → your one-person company of AI experts → complete deliverable in minutes… |
...
| [777genius/agent-teams-ai](https://github.com/777genius/agent-teams-ai) | 2,170 | TypeScript | Fastify, GitHub Actions, React | You&#39;re the boss, agents are your team. They handle tasks on their own, message each other… |
...
| [andyrewlee/awesome-agent-orchestrators](https://github.com/andyrewlee/awesome-agent-orchestrators) | 2,015 | — | GitHub Actions | List of agent orchestrators |
| [jim-schwoebel/awesome_ai_agents](https://github.com/jim-schwoebel/awesome_ai_agents) | 1,994 | — | — | 🤖 A comprehensive list of 1,500+ resources and tools related to AI agents. |
...
| [vstorm-co/full-stack-ai-agent-template](https://github.com/vstorm-co/full-stack-ai-agent-template) | 1,915 | Python | FastAPI, GitHub Actions, LangChain, LangGraph | Full-stack AI app generator — FastAPI + Next.js with AI Agents, RAG, streaming, auth, and… |
...
| [nimbalyst/nimbalyst](https://github.com/nimbalyst/nimbalyst) | 1,778 | TypeScript | Express, GitHub Actions, React | Nimbalyst - The open-source visual workspace for Claude Code, Codex, and OpenCode. Run mu… |
...
| [zhnt/loushang](https://github.com/zhnt/loushang) | 1,563 | Python | GitHub Actions | AI-native agent harness for coding workflows by python: multi-model LLM orchestration, st… |
...
| [agentlas-ai/Agentlas-OS](https://github.com/agentlas-ai/Agentlas-OS) | 1,448 | Python | GitHub Actions | Agent OS: keep specialist agents in a hub, spin up a temporary orchestrator per task. Loc… |
...
| [Rath-Team/OpenRath](https://github.com/Rath-Team/OpenRath) | 1,140 | Python | GitHub Actions, PyTorch, Pydantic | An open-source, PyTorch-like runtime for dynamic multi-agent and multi-session workflows. |
...
| [cognizant-ai-lab/neuro-san-studio](https://github.com/cognizant-ai-lab/neuro-san-studio) | 1,101 | Python | GitHub Actions, LangChain | A playground for neuro-san |
...
| [FareedKhan-dev/production-grade-agentic-system](https://github.com/FareedKhan-dev/production-grade-agentic-system) | 972 | Python | Docker, Docker Compose, FastAPI, LangChain | Core 7 layers of production grade agentic system |
| [adolfousier/opencrabs](https://github.com/adolfousier/opencrabs) | 945 | Rust | GitHub Actions, Tokio | The all-in-one AI agent living in your terminal. Build landing, mobile apps, backends, ma… |
...
| [w8123/EnterpriseAgentFramework](https://github.com/w8123/EnterpriseAgentFramework) | 819 | Java | — | ReachAI企业级智能体开发平台：快速、安全完成已有业务系统智能化改造，让 AI 在 OA、ERP、CRM 等原系统中查数据、填表单、办业务。ReachAI: Quickly… |
...
| [alikon-art/DeterminFlow](https://github.com/alikon-art/DeterminFlow) | 758 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | A production-oriented AI workflow runtime for building, validating, recovering, and shipp… |
| [Gnosil/semantix](https://github.com/Gnosil/semantix) | 740 | Go | GitHub Actions | semantic agent kernel which make agent efficient and self-evolve |
...
| [ethanplusai/astra-flash-orchestrator](https://github.com/ethanplusai/astra-flash-orchestrator) | 678 | Python | — | Astra plans and reviews; DeepSeek Flash builds. A native Codex workflow with phased tasks… |
...
| [Abilityai/trinity](https://github.com/Abilityai/trinity) | 585 | Python | Docker Compose, GitHub Actions, MCP SDK | Self-hosted AI Agents Platform supporting Claude Code, Codex, Gemini agents. Apache 2.0. |
...
| [androoAGI/starnet](https://github.com/androoAGI/starnet) | 575 | JavaScript | GitHub Actions | A living pixel-art station where real AI agents do real work. Local-first desktop agent h… |
...
| [agentpit-io/hunter-community](https://github.com/agentpit-io/hunter-community) | 551 | Python | Docker Compose, GitHub Actions | HunterCode · Community Edition · 腾讯 WorkBuddy 金融版的开源本地替代方案 · open-source, local alternati… |
...
| [razzant/claudexor](https://github.com/razzant/claudexor) | 484 | TypeScript | GitHub Actions | Multi-harness control plane for Claude Code, Codex, Cursor, and OpenCode: quota-aware rot… |
...
| [mvschwarz/openrig](https://github.com/mvschwarz/openrig) | 478 | TypeScript | GitHub Actions | Multi-agent harness that runs Claude Code and Codex together as one system |
...
| [Varietyz/Disciplined-AI-Software-Development](https://github.com/Varietyz/Disciplined-AI-Software-Development) | 410 | — | — | Disciplined AI Collaboration: a method for building software with AI. One loop at every s… |
...
| [giuliastro/harness-remote](https://github.com/giuliastro/harness-remote) | 387 | JavaScript | GitHub Actions | Native-session control plane for Codex, Claude Code, OpenCode, OMP and PI. Run, resume an… |
...
| [ant-research/AntOmniEvo](https://github.com/ant-research/AntOmniEvo) | 382 | Python | LangChain, LangGraph, Pydantic | An auto-evolution framework that optimizes anything — your 7×24 team of algorithm enginee… |
...
| [agents-universe/agents-universe](https://github.com/agents-universe/agents-universe) | 312 | Python | Docker, GitHub Actions | 不是问答机器人，而是能真正干活的数字分身。共享智能体，共享项目上下文，让项目所有成员一起协同工作。同时智能体会像人一样通过资料或者工作抽象和总结经验到项目上下文中 |
...
| [BlackBeltTechnology/pi-agent-dashboard](https://github.com/BlackBeltTechnology/pi-agent-dashboard) | 303 | TypeScript | GitHub Actions | Real-time web dashboard for pi coding-agent sessions. Multi-session view, live chat mirro… |
| [Cotal-AI/Cotal](https://github.com/Cotal-AI/Cotal) | 300 | TypeScript | GitHub Actions | The open standard for agent coordination |
| [huangjia2019/agent-design-patterns](https://github.com/huangjia2019/agent-design-patterns) | 284 | Python | FastAPI, GitHub Actions, LangChain, LangGraph | A 7×6 framework for agent architecture. 28 patterns, each placed at a coordinate, runnabl… |
...
| [toolclub/dsh-agent-team-gui](https://github.com/toolclub/dsh-agent-team-gui) | 263 | TypeScript | GitHub Actions, React | Persistent multi-model workflow teams for DeepSeek Harness — dynamic lead planning, bound… |
...
| [CoordClaw/CoordClaw](https://github.com/CoordClaw/CoordClaw) | 195 | TypeScript | — | CoordClaw: a multi-agent system that runs AI like a one-person company. Built on manageme… |
...
| [yicheng47/runner](https://github.com/yicheng47/runner) | 161 | Rust | GitHub Actions | Where terminal agents work together. Claude Code, Codex, Copilot CLI and pi on the same t… |
...
| [Pal-AI-Lab/Cortico](https://github.com/Pal-AI-Lab/Cortico) | 151 | TypeScript | Express, GitHub Actions, React | Event-stream AI Agent framework for building your persona bot 🍊 |
| [pqpo/pragma](https://github.com/pqpo/pragma) | 151 | TypeScript | GitHub Actions | Build portable agent teams across models and harnesses, with shared memory, skills, tools… |
...
| [ringlochid/oh-my-subagents](https://github.com/ringlochid/oh-my-subagents) | 146 | Python | Docker Compose, FastAPI, GitHub Actions, Pydantic | Local subagent orchestration for Codex and Claude, with persistent task state, reusable t… |
...
| [Agent-Analytics/awesome-multi-agent-orchestrators](https://github.com/Agent-Analytics/awesome-multi-agent-orchestrators) | 103 | TypeScript | GitHub Actions | Awesome-style curated list and directory for multi-agent orchestration. |
...
| [simota/agent-skills](https://github.com/simota/agent-skills) | 81 | Python | GitHub Actions | 90 specialist AI agents + 3 project-local extensions for Claude Code / Codex CLI / Antigr… |
...
| [hieuphung97/dely](https://github.com/hieuphung97/dely) | 78 | JavaScript | — | Multi-harness control protocol that turns requests into approved design contracts, orches… |
...
| [rekursiv-ai/sagent](https://github.com/rekursiv-ai/sagent) | 70 | Python | FastAPI, GitHub Actions, PyTorch, Pydantic | A coding-agent CLI and strongly-typed Python library -- self-mutating, hot-swapping, mult… |
...
| Project | Stars | Language | Stack | Description |
| --- | ---: | --- | --- | --- |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | 267,657 | JavaScript | GitHub Actions, TypeScript | The agent harness performance optimization system. Skills, instincts, memory, security, a… |
| [langgenius/dify](https://github.com/langgenius/dify) | 157,241 | TypeScript | GitHub Actions | Build Agentic workflows, RAG pipelines, with rich AI model and tool support on one collab… |
| [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) | 146,151 | JavaScript | GitHub Actions | Makes your AI agent think like the laziest senior dev in the room. The best code is the c… |
| [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | 85,502 | Python | GitHub Actions | Give your AI agent eyes to see the entire internet. Read &amp; search Twitter, Reddit, YouTub… |
| [unclecode/crawl4ai](https://github.com/unclecode/crawl4ai) | 84,279 | Python | Docker, Docker Compose, GitHub Actions, PyTorch | Open-source web crawler and scraper for LLMs and AI agents: any website into clean, LLM-r… |
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | 75,651 | Python | GitHub Actions | A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI w… |
| [headroomlabs-ai/headroom](https://github.com/headroomlabs-ai/headroom) | 73,834 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20% fewer t… |
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | 71,959 | JavaScript | GitHub Actions | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and li… |
| [upstash/context7](https://github.com/upstash/context7) | 62,433 | TypeScript | GitHub Actions | Context7 Platform -- Up-to-date code documentation for LLMs and AI code editors |
| [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | 54,627 | Python | GitHub Actions | A hand-picked collection of the finest of resources for the most awesome of agents, Claud… |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 52,619 | TypeScript | GitHub Actions | Chrome DevTools for coding agents |
| [sickn33/agentic-awesome-skills](https://github.com/sickn33/agentic-awesome-skills) | 46,931 | Python | GitHub Actions | AAS Core is the local, agent-first control plane for complete catalog discovery, agent-ow… |
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 44,943 | C | GitHub Actions | High-performance code intelligence MCP server. Indexes codebases into a persistent knowle… |
| [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | 41,028 | Python | Docker, FastAPI, GitHub Actions, Kubernetes | AI Agent Assistant &amp; development framework that integrates lots of IM platforms, LLMs, pl… |
| [wshobson/agents](https://github.com/wshobson/agents) | 39,981 | Python | GitHub Actions | Multi-harness agentic plugin marketplace for Claude Code, Codex, Cursor, OpenCode, GitHub… |
| [patchy631/ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub) | 38,032 | Python | — | In-depth tutorials on LLMs, RAGs and real-world AI agent applications. |
| [esengine/DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) | 35,710 | Go | GitHub Actions | DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stabili… |
| [agentscope-ai/QwenPaw](https://github.com/agentscope-ai/QwenPaw) | 35,267 | TypeScript | Docker Compose, GitHub Actions | Your Personal AI Assistant; easy to install, deploy on your own machine or on the cloud;… |
| [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) | 33,396 | Python | GitHub Actions | 817 structured cybersecurity skills for AI agents · Mapped to 6 frameworks: MITRE ATT&amp;CK,… |
| [tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph) | 31,796 | Python | GitHub Actions | Local-first code intelligence graph for MCP and CLI. Builds a persistent map of your code… |
| [feder-cr/invisible_playwright_mcp](https://github.com/feder-cr/invisible_playwright_mcp) | 31,669 | Python | GitHub Actions, Pydantic | Playwright MCP server undetected by anti-bots and captchas: AI agent browses the web on a… |
| [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | 30,325 | TypeScript | GitHub Actions, LangChain | Composio powers 1000+ toolkits, tool search, context management, authentication, and a sa… |
| [oraios/serena](https://github.com/oraios/serena) | 29,810 | Python | Docker, GitHub Actions, Pydantic | A powerful MCP toolkit for coding, providing semantic retrieval and editing capabilities… |
| [assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher) | 29,629 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | An autonomous agent that conducts deep research on any data using any LLM providers |
| [ahujasid/mcp-for-blender](https://github.com/ahujasid/mcp-for-blender) | 29,375 | Python | Docker | Community plugin to control Blender 3D with any LLM of your choice |
...
| [mastra-ai/mastra](https://github.com/mastra-ai/mastra) | 28,339 | TypeScript | GitHub Actions | Mastra is the modern TypeScript framework for AI-powered applications and agents. |
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | 28,136 | TypeScript | Docker, GitHub Actions, React | An open-source AI coding agent that lives in your terminal. |
| [PrefectHQ/fastmcp](https://github.com/PrefectHQ/fastmcp) | 27,904 | Python | FastAPI, GitHub Actions, LangChain, Pydantic | 🚀 The fast, Pythonic way to build MCP servers and clients. |
| [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) | 26,482 | Python | GitHub Actions | 380 Claude Code skills &amp; agent skills &amp; plugins (30+ Agents, 70+ custom commands, 380+ sk… |
| [titanwings/distilly](https://github.com/titanwings/distilly) | 25,036 | Python | GitHub Actions | Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Col… |
| [activepieces/activepieces](https://github.com/activepieces/activepieces) | 24,733 | TypeScript | Docker, Docker Compose, GitHub Actions | AI Agents &amp; MCPs &amp; AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automat… |
| [pascalorg/editor](https://github.com/pascalorg/editor) | 24,315 | TypeScript | Docker, Docker Compose, GitHub Actions, Next.js | Open-source 3D architectural editor with a local CLI, MCP tools, and practical workflows… |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | 24,076 | TypeScript | GitHub Actions, MCP SDK | Context window optimization for AI coding agents. Sandboxes tool output (98% reduction),… |
...
| [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | 23,000 | TypeScript | Docker, Docker Compose, Express, GitHub Actions | A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you |
| [screenpipe/screenpipe](https://github.com/screenpipe/screenpipe) | 21,715 | Rust | GitHub Actions, React, Tokio | YC (S26) \| Open Computer History \| Record your screen continuously locally and provide… |
| [liyupi/ai-guide](https://github.com/liyupi/ai-guide) | 20,483 | JavaScript | GitHub Actions | 程序员鱼皮的 AI 资源大全 + Vibe Coding 零基础教程，分享 OpenClaw 保姆级教程、大模型玩法（DeepSeek / GPT / Gemini / Clau… |
| [datawhalechina/easy-vibe](https://github.com/datawhalechina/easy-vibe) | 19,548 | JavaScript | Docker, GitHub Actions | 💻  vibe coding 101｜The first course for AI-native product builders. |
| [NVIDIA/SkillSpector](https://github.com/NVIDIA/SkillSpector) | 18,323 | Python | Docker, GitHub Actions, LangChain, LangGraph | Security scanner for AI agent skills. Detect vulnerabilities, malicious patterns, securit… |
...
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | 17,752 | Python | GitHub Actions | GenBI (Generative BI) for AI agents, an open-source, governed text-to-SQL through an open… |
| [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners) | 17,312 | TypeScript | — | This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) t… |
| [wanshuiyin/Auto-claude-code-research-in-sleep](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep) | 16,662 | Python | GitHub Actions | ARIS ⚔️ (Auto-Research-In-Sleep) — Lightweight Markdown-only skills for autonomous ML res… |
| [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire) | 16,542 | Python | — | AI 时代的伯克希尔：基于 Claude Code / Codex 的价值投资研究框架。巴菲特·芒格·段永平·李录四大师方法论 + 多Agent并行研究。\| AI-era Be… |
...
| [hypit-ai/hypit](https://github.com/hypit-ai/hypit) | 16,133 | TypeScript | GitHub Actions | Clone any viral video with AI agents. Not just a script, the whole workflow: swap the fac… |
| [walkinglabs/learn-harness-engineering](https://github.com/walkinglabs/learn-harness-engineering) | 16,081 | TypeScript | GitHub Actions | Harness engineering beginner tutorial, from 0 to 1 |
| [HBAI-Ltd/Toonflow-app](https://github.com/HBAI-Ltd/Toonflow-app) | 16,042 | TypeScript | Docker, GitHub Actions | Toonflow 是开源 AI 创作平台，融合无限画布、AI Agent 与可视化工作流，支持图像生成、视频生成、智能分镜及短剧创作。支持本地部署、自由接入模型，提供跨平台桌面端… |
...
| [NanmiCoder/cc-haha](https://github.com/NanmiCoder/cc-haha) | 14,719 | TypeScript | GitHub Actions, MCP SDK, React | Local-first cross-platform desktop workspace for Claude Code / agents: multi-agent, Git w… |
| [CoplayDev/unity-mcp](https://github.com/CoplayDev/unity-mcp) | 14,496 | C# | Docker Compose, GitHub Actions | Unity MCP acts as a bridge between AI assistants and your Unity Editor. Give your LLM too… |
...
| [tonhowtf/omniget](https://github.com/tonhowtf/omniget) | 14,367 | Rust | GitHub Actions, TypeScript | Udemy &amp; Hotmart course downloader, YouTube downloader (yt-dlp GUI, 1,800+ sites) + deskto… |
| [rocketride-org/rocketride-server](https://github.com/rocketride-org/rocketride-server) | 12,394 | Python | FastAPI, GitHub Actions, TypeScript | High-performance AI pipeline engine with a C++ core and 50+ Python-extensible nodes. Buil… |
| [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | 12,336 | Python | GitHub Actions | AI-powered reverse engineering assistant that bridges IDA Pro with language models throug… |
| [corsairdev/corsair](https://github.com/corsairdev/corsair) | 12,154 | TypeScript | GitHub Actions | Connect your users to their apps |
| [0x4m4/hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | 12,106 | Python | — | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copil… |
...
| [holaboss-ai/holaOS](https://github.com/holaboss-ai/holaOS) | 11,404 | TypeScript | GitHub Actions | Open-source agentic workspace enterprises can make their own. Connect the systems you alr… |
| [cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) | 11,314 | TypeScript | GitHub Actions | Practical patterns, starters &amp; CLI tools for loop engineering with AI coding agents. Desi… |
...
| [ykdojo/claude-code-tips](https://github.com/ykdojo/claude-code-tips) | 10,145 | JavaScript | GitHub Actions | 45+ tips for getting the most out of Claude Code, from basics to advanced - includes a cu… |
| [awslabs/mcp](https://github.com/awslabs/mcp) | 9,730 | Python | GitHub Actions | Open source MCP Servers for AWS |
| [trailhq/Graft](https://github.com/trailhq/Graft) | 9,237 | TypeScript | Docker, GitHub Actions | Turbocharge Claude Code, Cursor, Codex, Gemini &amp; every coding agent: faster, cheaper, wit… |
| [google/adk-go](https://github.com/google/adk-go) | 8,826 | Go | GitHub Actions, gRPC | An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticat… |
...
| [apify/apify-mcp-server](https://github.com/apify/apify-mcp-server) | 8,539 | TypeScript | Docker, Express, GitHub Actions, MCP SDK | The Apify MCP server enables your AI agents to extract data from social media, search eng… |
...
| [jnMetaCode/superpowers-zh](https://github.com/jnMetaCode/superpowers-zh) | 8,212 | JavaScript | GitHub Actions | 🦸 AI 编程超能力 · 中文增强版 — superpowers（250k+ ⭐）完整汉化 + 4 个中国原创 skills，让 Claude Code / Copilot C… |
| [osaurus-ai/osaurus](https://github.com/osaurus-ai/osaurus) | 7,999 | Swift | GitHub Actions | Own your AI. The native macOS harness for AI agents -- any model, persistent memory, auto… |
...
| [Gentleman-Programming/gentle-ai](https://github.com/Gentleman-Programming/gentle-ai) | 7,304 | Go | GitHub Actions | Gentle-AI configures the AI coding agents you already use: Claude Code, Cursor, OpenCode,… |
...
| [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) | 7,030 | TypeScript | Docker, Express, GitHub Actions | Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators… |
| [XiaoDuoYa/codex-with-chatgpt](https://github.com/XiaoDuoYa/codex-with-chatgpt) | 6,681 | TypeScript | Express, MCP SDK | ChatGPT thinks. Codex works. Use ChatGPT as the planning brain while keeping the Codex ha… |
| [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) | 6,588 | Python | Docker, Docker Compose, Gin, GitHub Actions | A full-stack AI Red Teaming platform securing AI ecosystems via Agent Scan, Skills Scan,… |
| [getsentry/MobileBuildMCP](https://github.com/getsentry/MobileBuildMCP) | 6,428 | TypeScript | GitHub Actions, MCP SDK | A Model Context Protocol (MCP) server and CLI that provides tools for agent use when work… |
| [ThinkInAIXYZ/deepchat](https://github.com/ThinkInAIXYZ/deepchat) | 6,344 | TypeScript | GitHub Actions, MCP SDK | 🐬DeepChat - A smart assistant that connects powerful AI to your personal world |
...
| [kucherenko/jscpd](https://github.com/kucherenko/jscpd) | 6,273 | Rust | Docker, GitHub Actions | Copy/paste detector for source code. 220+ languages, Rust engine, SARIF/HTML/badge report… |
...
| [Q00/ouroboros](https://github.com/Q00/ouroboros) | 6,104 | Python | GitHub Actions, Pydantic | Agent OS: the agent gets smarter on its own. We just hold the line: Interview-gated, stag… |
...
| [21st-dev/magic-mcp](https://github.com/21st-dev/magic-mcp) | 5,927 | TypeScript | Docker, GitHub Actions | It&#39;s like v0, but in your Cursor / Claude Code / Windsurf: search 10,000+ React/Tailwind… |
...
| [callstack/agent-device](https://github.com/callstack/agent-device) | 4,778 | TypeScript | GitHub Actions | Mobile app automation and verification for AI coding agents. CLI, MCP server, and typed N… |
| [macro-inc/macro](https://github.com/macro-inc/macro) | 4,402 | Rust | GitHub Actions, Tokio | Macro is a unified workspace for teams: email, chat, docs, tasks, agents, calls, and CRM… |
...
| [nolabs-ai/nono](https://github.com/nolabs-ai/nono) | 4,233 | Rust | GitHub Actions, Tokio | agent runtime security - zero trust, zero setup, zero latency. |
...
| [xiaobright/dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 3,793 | JavaScript | GitHub Actions | Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard tools (P… |
| [strukto-ai/mirage](https://github.com/strukto-ai/mirage) | 3,662 | TypeScript | GitHub Actions | The World&#39;s First Virtual Terminal for AI Agents |
| [stickerdaniel/linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | 3,629 | Python | Docker, Docker Compose, GitHub Actions, Pydantic | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatible AI agent access t… |
| [google-antigravity/antigravity-sdk-python](https://github.com/google-antigravity/antigravity-sdk-python) | 3,530 | Python | GitHub Actions, Pydantic | A Python library for building AI agents that leverage the full power of Google Antigravit… |
| [onecli/onecli](https://github.com/onecli/onecli) | 3,516 | TypeScript | GitHub Actions | Open-source sandboxed agent harness for teams. Giving every employee a secured personal a… |
| [skyhook-io/radar](https://github.com/skyhook-io/radar) | 3,494 | Go | Docker, GitHub Actions, gRPC | The missing open-source Kubernetes UI with a built-in MCP server for AI agents. See what&#39;… |
...
| [amitshekhariitbhu/ai-engineering-interview-questions](https://github.com/amitshekhariitbhu/ai-engineering-interview-questions) | 3,199 | Markdown | — | Your Cheat Sheet for AI Engineering Interview – Questions and Answers. |
...
| [yilewang/llm-for-zotero](https://github.com/yilewang/llm-for-zotero) | 3,149 | TypeScript | GitHub Actions | An open-source research agent system for your Zotero library. |
| [TanStack/ai](https://github.com/TanStack/ai) | 3,139 | TypeScript | GitHub Actions | 🤖 Type-safe, provider-agnostic TypeScript AI SDK for streaming chat, tool calling, agent… |
| [ascending-llc/jarvis-registry](https://github.com/ascending-llc/jarvis-registry) | 3,135 | Python | Docker Compose, FastAPI, GitHub Actions | Connect any AI copilot or autonomous agent to your enterprise tools — through a single, s… |
...
| [wesammustafa/Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know) | 3,054 | Python | GitHub Actions | A practical Claude Code guide with clear mental models and copy-paste examples — setup, p… |
...
| [jeremylongshore/tons-of-skills-marketplace](https://github.com/jeremylongshore/tons-of-skills-marketplace) | 2,791 | Python | GitHub Actions, TypeScript | Model-agnostic agent-skills platform with a harness-free canonical layer, verified adapte… |
| [Owl-Listener/designer-skills](https://github.com/Owl-Listener/designer-skills) | 2,769 | Python | GitHub Actions | Designer Skills Collection: agentic skills, commands, and plugins for design — from resea… |
...
| [beenuar/AiSOC](https://github.com/beenuar/AiSOC) | 2,368 | Python | Docker Compose, GitHub Actions, TypeScript | Open-source AI Security Operations Center: alert fusion, LLM-agent triage, MITRE ATT&amp;CK i… |
...
| [redhat-et/ripwire](https://github.com/redhat-et/ripwire) | 2,342 | C++ | GitHub Actions | The ripgrep of AI context: a zero-dependency C++23 CLI + MCP server for coding agents. Fi… |
| [Open-Curiosity/gini-agent](https://github.com/Open-Curiosity/gini-agent) | 2,318 | TypeScript | Docker, Docker Compose, GitHub Actions | The agent that remembers and learns. |
...
| [0xsline/OpenChatCut](https://github.com/0xsline/OpenChatCut) | 2,002 | TypeScript | GitHub Actions, MCP SDK, React | Open-source, local-first conversational AI video editor with a professional multi-track t… |
| [MemTensor/memmy-agent](https://github.com/MemTensor/memmy-agent) | 1,982 | TypeScript | GitHub Actions | 🍙  A personal AI agent &amp; local memory hub for all AI agents, gives every AI one shared,… |
...
| [arabold/docs-mcp-server](https://github.com/arabold/docs-mcp-server) | 1,761 | TypeScript | Docker, Docker Compose, Fastify, GitHub Actions | Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools |
...
| [video-db/call.md](https://github.com/video-db/call.md) | 1,443 | TypeScript | MCP SDK, React | Turn meetings into live agent loops. Record, transcribe, and analyze meetings with real-t… |
| [inkeep/agents](https://github.com/inkeep/agents) | 1,437 | TypeScript | Docker Compose, GitHub Actions, MCP SDK, NestJS | Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For… |
...
| [nvk/llm-wiki](https://github.com/nvk/llm-wiki) | 1,347 | Python | — | LLM-compiled knowledge bases for any AI agent. Parallel multi-agent research, thesis-driv… |
...
| [heymrun/heym](https://github.com/heymrun/heym) | 1,278 | Python | Docker Compose, GitHub Actions | Build agentic systems. Run them with confidence. Orchestrate agents, automate business pr… |
...
| [K-Dense-AI/k-dense-byok](https://github.com/K-Dense-AI/k-dense-byok) | 1,256 | TypeScript | GitHub Actions | An AI co-scientist running on your desktop. Claude Science but better. |
...
| [Gentleman-Programming/gentle-shell](https://github.com/Gentleman-Programming/gentle-shell) | 1,099 | TypeScript | GitHub Actions | Gentle Shell is a Pi-native coding-agent harness for controlled development with Organic… |
...
| [RyanAlberts/best-of-Agent-Harnesses](https://github.com/RyanAlberts/best-of-Agent-Harnesses) | 975 | Python | GitHub Actions | 🏆 Ranked list of 167 AI agent harnesses, plus copy-paste templates (AGENTS.md, safe Clau… |
...
| [LLMQuant/awesome-trading-agents](https://github.com/LLMQuant/awesome-trading-agents) | 853 | — | GitHub Actions | Curated list of LLM-driven trading agents, MCP servers, and agent skills for market resea… |
...
| [risa-labs-inc/BossConsole](https://github.com/risa-labs-inc/BossConsole) | 806 | Kotlin | GitHub Actions | Open-source, multi-platform harness for AI agents - a native, multi-threaded operator&#39;s c… |
...
| [aoci-spec/aoci-code](https://github.com/aoci-spec/aoci-code) | 609 | Go | GitHub Actions | A persistent, Git-versioned map of your whole codebase and database schema that coding ag… |
...
| [livecontext-ai/livecontext-ce](https://github.com/livecontext-ai/livecontext-ce) | 550 | Java | Docker Compose | The AI automation platform, self-hosted. Describe the job in chat and LiveContext builds… |
...
| [qiz029/dscode](https://github.com/qiz029/dscode) | 509 | JavaScript | GitHub Actions, MCP SDK, React, TypeScript | A DeepSeek coding agent harness: persistent shell, Ultra subagents, auto approval, Chrome… |
| [deonmenezes/mantishack](https://github.com/deonmenezes/mantishack) | 504 | Rust | GitHub Actions, MCP SDK | Mantis Hack |
| [chenxiachan/thoughtdag](https://github.com/chenxiachan/thoughtdag) | 492 | TypeScript | Express, GitHub Actions, React | Your thinking deserves a map: an infinite canvas where LLM conversations grow into an edi… |
...
| [Dominic789654/awesome-deepseek-harness](https://github.com/Dominic789654/awesome-deepseek-harness) | 351 | TypeScript | GitHub Actions | A curated list of plugins, skills, MCP servers, patch/profile layers, orchestrators &amp; UIs… |
...
| [CatCatUncle/openworkbuddy](https://github.com/CatCatUncle/openworkbuddy) | 203 | JavaScript | Docker, Docker Compose, Express, GitHub Actions | Open-source Claude Cowork / Codex / WorkBuddy alternative — a local-first AI office agent… |
...
| [XiaoPuOuO/openchatx-mcp](https://github.com/XiaoPuOuO/openchatx-mcp) | 116 | TypeScript | Express, GitHub Actions | Turn ChatGPT into a local agent runtime. Operate your computer, use local tools, discover… |
...
| [kyashrathore/Claxedo](https://github.com/kyashrathore/Claxedo) | 84 | TypeScript | GitHub Actions | Open-source coding-agent workspace: desktop app + composable TypeScript framework for bui… |
...
| [pepe-agent/pepe](https://github.com/pepe-agent/pepe) | 55 | Elixir | Docker, Docker Compose, GitHub Actions | An Elixir/OTP AI agent runtime: define agents, connect any OpenAI-compatible model, and r… |
...
| Project | Stars | Language | Stack | Description |
| --- | ---: | --- | --- | --- |
| [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 187,565 | Python | GitHub Actions | AutoGPT is the vision of accessible AI for everyone, to use and to build on. Our mission… |
| [asgeirtj/system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks) | 68,373 | JavaScript | — | Documented system prompts from Anthropic - Claude Fable 5.1, Opus 5.5, Claude Design, Cla… |
| [shanraisshan/claude-code-best-practice](https://github.com/shanraisshan/claude-code-best-practice) | 66,370 | Python | — | from vibe coding to agentic engineering - practice makes claude perfect |
| [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage) | 61,328 | Python | FastAPI, GitHub Actions | World&#39;s first open-source, agentic video production system. 12 production pipelines, 100+… |
...
| [charmbracelet/crush](https://github.com/charmbracelet/crush) | 28,309 | Go | GitHub Actions, gRPC | Glamourous agentic coding for all 💘 |
| [Fosowl/agenticSeek](https://github.com/Fosowl/agenticSeek) | 27,329 | Python | Docker Compose, FastAPI, PyTorch, Pydantic | Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thin… |
| [VoltAgent/awesome-claude-code-subagents](https://github.com/VoltAgent/awesome-claude-code-subagents) | 25,333 | Shell | GitHub Actions | A collection of 100+ specialized Claude Code subagents covering a wide range of developme… |
| [microsoft/agent-lightning](https://github.com/microsoft/agent-lightning) | 18,474 | Python | FastAPI, GitHub Actions, PyTorch, Pydantic | The absolute trainer to light up AI agents. |
...
| [browser-use/browser-harness](https://github.com/browser-use/browser-harness) | 18,119 | Python | GitHub Actions | Browser Harness \| Self-healing harness that enables LLMs to complete any task. |
| [tradecatlabs/vibe-coding-cn](https://github.com/tradecatlabs/vibe-coding-cn) | 16,386 | Python | GitHub Actions | Vibe Coding 从入门到精通教程｜AI 结对编程工作流｜Prompt、Skill、Workflow、上下文管理、codex实战指南 |
...
| [mahseema/awesome-ai-tools](https://github.com/mahseema/awesome-ai-tools) | 6,280 | — | — | A curated list of Artificial Intelligence Top Tools |
| [truefoundry/trueforge](https://github.com/truefoundry/trueforge) | 5,970 | TypeScript | Docker, Docker Compose, GitHub Actions | The open-source agent harness - the runtime layer that turns an LLM into a working agent. |
...
| [rllm-org/rllm](https://github.com/rllm-org/rllm) | 5,839 | Python | Docker, GitHub Actions, LangChain, LangGraph | Democratizing Reinforcement Learning for LLMs |
| [apache/maka](https://github.com/apache/maka) | 5,663 | TypeScript | GitHub Actions, MCP SDK | Apache Maka (Incubating) is a high-performance agent workspace that keeps a complete reco… |
...
| [ruc-datalab/DeepAnalyze](https://github.com/ruc-datalab/DeepAnalyze) | 4,654 | Python | FastAPI | DeepAnalyze is the first agentic LLM for autonomous data science. 🎈你的AI数据分析师，自动分析大量数据，一键… |
...
| [walkinglabs/awesome-harness-engineering](https://github.com/walkinglabs/awesome-harness-engineering) | 4,158 | — | GitHub Actions | 🛠️ Awesome tools &amp; guides for harness engineering. |
| [kirodotdev/KiroCrew](https://github.com/kirodotdev/KiroCrew) | 4,150 | Python | GitHub Actions | A persistent workspace for development work that self-improves and continues beyond one s… |
| [sergebulaev/linkedin-skills](https://github.com/sergebulaev/linkedin-skills) | 3,514 | Python | GitHub Actions | Claude skills for LinkedIn. 11 Claude Code and Codex skills that write human-sounding Lin… |
...
| [bergside/awesome-design-skills](https://github.com/bergside/awesome-design-skills) | 2,929 | — | — | List of 67 awesome DESIGN.md and SKILL.md design skill files for agentic tools like Claud… |
...
| [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness) | 2,803 | Python | GitHub Actions, LangChain, LangGraph, Pydantic | Visa Vulnerability Agentic Harness |
| [QwenAudio/qwen-audio-agent](https://github.com/QwenAudio/qwen-audio-agent) | 2,765 | JavaScript | Express, GitHub Actions, MCP SDK | A realtime voice runtime that keeps Agents talking, working, and present.  Real-time Voic… |
...
| [samugit83/redamon](https://github.com/samugit83/redamon) | 2,598 | Python | Docker Compose | An AI-powered agentic red team framework that automates offensive security operations, fr… |
...
| [scadastrangelove/awesome-ai-security-tools](https://github.com/scadastrangelove/awesome-ai-security-tools) | 1,544 | Python | GitHub Actions | A curated list of public-source, research, and commercial tools for AI security and AI-as… |
...
| [jsmastery-pro/skills](https://github.com/jsmastery-pro/skills) | 1,331 | JavaScript | GitHub Actions | Agentic Development skills behind the JS Mastery workflow |
...
| [hoangnb24/repository-harness](https://github.com/hoangnb24/repository-harness) | 1,224 | Rust | GitHub Actions | Turn any repo into an agent-ready workspace for Claude Code, Codex, Cursor, and other cod… |
| [rasbt/mini-coding-agent](https://github.com/rasbt/mini-coding-agent) | 1,182 | Python | GitHub Actions | Minimal and readable coding agent harness implementation in Python to explain the core co… |
...
| [OpenSparX/MasterAgent](https://github.com/OpenSparX/MasterAgent) | 1,081 | C++ | GitHub Actions | Build AI agents that run 100% on-device. Sub-100ms latency on Qualcomm NPU. Zero cloud de… |
...
| [hardness1020/learn-agent-architecture](https://github.com/hardness1020/learn-agent-architecture) | 996 | Python | — | Learn AI agents from scratch. |
...
| [autonomous-ai/openharness](https://github.com/autonomous-ai/openharness) | 948 | C | GitHub Actions | The ultimate harness for coding agents and beyond. All your agents. All your machines. On… |
...
| [datagallery-ai/dataagent](https://github.com/datagallery-ai/dataagent) | 778 | TypeScript | GitHub Actions, React | DataFoundry is an open-source AI workbench for data analysis, unifying data sources, know… |
...
| [ranxi2001/zero2Agent](https://github.com/ranxi2001/zero2Agent) | 542 | Python | GitHub Actions | 面向大厂Agent研发岗位求职的agent教程网站，涵盖技术路线与面试八股文 |
...
| [Birfy/agentdescent](https://github.com/Birfy/agentdescent) | 244 | Python | GitHub Actions | Gradient descent, but the parameters are agents — a parallel, asynchronous framework for… |
...
| [ever-works/ever-works](https://github.com/ever-works/ever-works) | 145 | TypeScript | Docker Compose, GitHub Actions | Ever® Works™ - The Workshop for AI. An open agentic runtime that autonomously researches,… |
...
| [Agent-Field/CodeAF](https://github.com/Agent-Field/CodeAF) | 127 | Go | GitHub Actions | Open-Source Software factory for Open Models |
...
| [rsi-gear/gear](https://github.com/rsi-gear/gear) | 117 | TypeScript | GitHub Actions | Gear (General Evolution Architecture) is RSI infrastructure for AI agents. Use Gear to re… |
...
| Project | Stars | Language | Stack | Description |
| --- | ---: | --- | --- | --- |
| [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 121,513 | Python | Docker, GitHub Actions | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowle… |
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | 94,713 | TypeScript | Docker Compose, Express, GitHub Actions, MCP SDK | Persistent Context Across Sessions for Every Agent –  Captures everything your agent does… |
| [infiniflow/ragflow](https://github.com/infiniflow/ragflow) | 91,315 | Go | Docker, Gin, GitHub Actions, LangGraph | RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses c… |
| [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) | 78,640 | MDX | GitHub Actions, Next.js, React, TypeScript | 🐙 Guides, papers, lessons, notebooks and resources for prompt engineering, context engin… |
| [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | 66,481 | JavaScript | GitHub Actions | Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerf… |
...
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | 51,074 | Python | FastAPI, GitHub Actions, LangChain, PyTorch | 《深入理解 AI Agent：设计原理与工程实践》（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码 |
| [volcengine/OpenViking](https://github.com/volcengine/OpenViking) | 38,701 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | Self-evolving Context Database for AI Agents. Unify Agent Memory, Knowledge RAG and Skill… |
| [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex) | 35,857 | Python | GitHub Actions | 📑 PageIndex: Document Index for Vectorless, Reasoning-based RAG |
| [virgiliojr94/book-to-skill](https://github.com/virgiliojr94/book-to-skill) | 32,478 | Python | GitHub Actions | Turn any technical book PDF into a Claude Code skill — ready to study, reference, and use… |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | 30,987 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | Cognee is the open-source AI memory platform for agents. Give your AI agents persistent l… |
| [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) | 30,349 | Python | GitHub Actions, Next.js, PyTorch | Hindsight: Agent Memory That Learns |
| [Tencent/WeKnora](https://github.com/Tencent/WeKnora) | 30,184 | Go | Docker Compose, Gin, GitHub Actions, gRPC | Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomou… |
...
| [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) | 28,864 | TypeScript | Docker Compose, GitHub Actions | #1 Persistent memory for AI coding agents based on real-world benchmarks |
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | 27,286 | TypeScript | GitHub Actions | TencentDB Agent Memory is a team-level memory hub for AI Agents — turning conversations,… |
| [deepset-ai/haystack](https://github.com/deepset-ai/haystack) | 26,605 | Python | GitHub Actions, PyTorch, Pydantic | Open-source AI orchestration framework for building context-engineered, production-ready… |
...
| [pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai) | 20,186 | Python | GitHub Actions, LangChain, PyTorch, Pydantic | How Python does AI. Agents, realtime voice, image generation, embeddings. Every model, ev… |
| [NevaMind-AI/memU](https://github.com/NevaMind-AI/memU) | 14,427 | Python | GitHub Actions, Pydantic | Personal memory across agents |
| [lsdefine/GenericAgent](https://github.com/lsdefine/GenericAgent) | 14,251 | Python | GitHub Actions | Self-evolving agent: grows skill tree from 3.3K-line seed, achieving full system control… |
| [nidhinjs/prompt-master](https://github.com/nidhinjs/prompt-master) | 13,673 | — | — | A Claude skill that writes the accurate prompts for any AI tool. Zero tokens or credits w… |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | 13,475 | Python | Docker, Docker Compose, FastAPI, GitHub Actions | Graph-Native Infrastructure for Context and Accountable AI Systems |
| [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) | 13,206 | Python | FastAPI, GitHub Actions, Pydantic | One portable memory layer for every AI agent: local-first, Markdown-native, user-owned, a… |
| [neuml/txtai](https://github.com/neuml/txtai) | 12,983 | Python | GitHub Actions | 💡 All-in-one AI framework for semantic search, LLM orchestration and language model work… |
...
| [simular-ai/Agent-S](https://github.com/simular-ai/Agent-S) | 12,378 | Python | FastAPI, GitHub Actions | Agent S: an open agentic framework that uses computers like a human |
| [cocoindex-io/cocoindex](https://github.com/cocoindex-io/cocoindex) | 11,601 | Rust | GitHub Actions, PyTorch, Pydantic, Tokio | Incremental engine for long horizon agents 🌟 Star if you like it! |
| [MemTensor/MemOS](https://github.com/MemTensor/MemOS) | 11,594 | TypeScript | Docker, FastAPI, GitHub Actions, LangChain | Self-evolving memory OS for LLM &amp; AI Agents: ultra-persistent memory, hybrid-retrieval, a… |
...
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | 7,344 | Python | Docker, FastAPI, GitHub Actions, Pydantic | Memory library for building stateful agents |
...
| [MinishLab/semble](https://github.com/MinishLab/semble) | 6,143 | Python | GitHub Actions | Fast and Accurate Code Search for Agents. Uses 99% fewer tokens than grep+read |
...
| [the-open-agent/openagent](https://github.com/the-open-agent/openagent) | 5,655 | Go | Docker, Docker Compose, GitHub Actions, gRPC | ⚡️next-generation personal AI assistant powered by LLM, RAG and agent loops, supporting c… |
| [volcengine/MineContext](https://github.com/volcengine/MineContext) | 5,527 | Python | FastAPI, GitHub Actions, Pydantic | MineContext is your proactive context-aware AI partner（Context-Engineering+ChatGPT Pulse） |
| [TencentCloud/Octop](https://github.com/TencentCloud/Octop) | 4,994 | Python | FastAPI, GitHub Actions, LangChain, LangGraph | A smarter, self-hosted AI assistant — multi-user, multi-agent. |
...
| [eugeniughelbur/obsidian-second-brain](https://github.com/eugeniughelbur/obsidian-second-brain) | 4,612 | Python | GitHub Actions | Persistent memory for Claude Code and 6 other CLI agents, stored as plain markdown in you… |
...
| [crmne/ruby_llm](https://github.com/crmne/ruby_llm) | 4,412 | Ruby | GitHub Actions | The Ruby-native AI framework. Chats, agents, tools, images, audio, and video through one… |
| [GiovanniPasq/agentic-rag-for-dummies](https://github.com/GiovanniPasq/agentic-rag-for-dummies) | 4,205 | Python | LangChain, LangGraph | A modular Agentic RAG built with LangGraph — learn Retrieval-Augmented Generation Agents… |
...
| [NVIDIA/skills](https://github.com/NVIDIA/skills) | 3,442 | Python | GitHub Actions | Agent Skills for NVIDIA products — install into Claude Code, Codex, and other coding agen… |
...
| [cortexkit/magic-context](https://github.com/cortexkit/magic-context) | 2,212 | TypeScript | GitHub Actions, Tokio | Unbounded context. Memory that manages itself. One session, for life. The hippocampus for… |
...
| [vellum-ai/vellum-assistant](https://github.com/vellum-ai/vellum-assistant) | 1,324 | TypeScript | GitHub Actions | An AI Assistant that’s easy to setup, does your work 24/7, knows your preferences and get… |
...
| [open-gsd/gsd-pi](https://github.com/open-gsd/gsd-pi) | 1,263 | TypeScript | Docker, GitHub Actions, MCP SDK | A powerful meta-prompting, context engineering and spec-driven development system that en… |
...
| [oceanbase/powercontext](https://github.com/oceanbase/powercontext) | 1,146 | Python | FastAPI, GitHub Actions, LangChain, LangGraph | Not only memory but a full story. |
...
| [adongwanai/learn-workbuddy](https://github.com/adongwanai/learn-workbuddy) | 380 | Python | GitHub Actions | 从 0 复刻 WorkBuddy-style 桌面 AI 助手 Harness：24 章 Python 教程，覆盖 Agent Loop、工具调用、记忆系统、Sidecar、沙盒… |
...
| [agenticloops-ai/agentic-ai-engineering](https://github.com/agenticloops-ai/agentic-ai-engineering) | 353 | Python | GitHub Actions | Hands-on tutorials for building AI agents from scratch. Learn LLM APIs, prompt engineerin… |
...
| [Gen-Verse/Recuris](https://github.com/Gen-Verse/Recuris) | 218 | Python | FastAPI, GitHub Actions, Pydantic | Recursive Experiential–Working Memory Evolution for Long-Horizon Agent Harnesses |
...
| [Mintplex-Labs/anythingllm-mobile](https://github.com/Mintplex-Labs/anythingllm-mobile) | 106 | TypeScript | GitHub Actions, React | An AI Agent that lives in your pocket. Local-first and privacy focused. |
...
| [zero11924065-dev/VetarAI](https://github.com/zero11924065-dev/VetarAI) | 82 | Python | — | VetarAI 是一款运行在本地的agent桌面应用，可自由创建多个隔离项目，项目内动态编排主 Agent 与子 Agent。原生支持任务委派、可视化工作流等。全部数据保存在本地… |
...
| [FailproofAI/failproofai](https://github.com/FailproofAI/failproofai) | 5,159 | TypeScript | GitHub Actions, Next.js, React | Observability and enforcement for AI agent harnesses. Capture every run and runtime relia… |
...
| [HolmesGPT/holmesgpt](https://github.com/HolmesGPT/holmesgpt) | 3,458 | Python | Docker, FastAPI, GitHub Actions, Pydantic | SRE Agent - CNCF Sandbox Project |
...
| [ShenSeanChen/waku-agent](https://github.com/ShenSeanChen/waku-agent) | 1,841 | Python | GitHub Actions, LangGraph, PyTorch | Waku Waku! Waku Agent is a local-first AI agent harness you actually own, including loop,… |
...
| [TIGER-AI-Lab/ClawBench](https://github.com/TIGER-AI-Lab/ClawBench) | 857 | Python | GitHub Actions | Open-source benchmark for browser AI agents on daily tasks. |
...
| [Anil-matcha/awesome-muse-connectors](https://github.com/Anil-matcha/awesome-muse-connectors) | 1,080 | Python | — | A source-backed catalog of Meta Muse integrations and community connector skills, with ca… |
...
| [Keesan12/martin-loop](https://github.com/Keesan12/martin-loop) | 222 | TypeScript | GitHub Actions | Make AI coding agents safe to scale autonomously: assign work, cap spend, enforce policy,… |
...
| [KbWen/agentic-os](https://github.com/KbWen/agentic-os) | 189 | Python | GitHub Actions | Governance framework for AI coding agents. It runs them through a five-step workflow (pla… |
...
| [e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) | 30,173 | — | — | A list of AI autonomous agents |
...
| [e2b-dev/E2B](https://github.com/e2b-dev/E2B) | 13,973 | Python | GitHub Actions, TypeScript | Open-source, secure environment with real-world tools for enterprise-grade agents. |
...
| [nexu-io/html-anything](https://github.com/nexu-io/html-anything) | 8,949 | TypeScript | GitHub Actions | ✨ The agentic HTML editor — your local AI agent writes the HTML, you ship it. 🚀 75 Skill… |
| [steel-dev/steel-browser](https://github.com/steel-dev/steel-browser) | 7,694 | TypeScript | Docker, Docker Compose, Fastify, GitHub Actions | 🔥 Open Source Browser API for AI Agents &amp; Apps. Steel Browser is a batteries-included br… |
| [agent-infra/sandbox](https://github.com/agent-infra/sandbox) | 6,015 | Python | GitHub Actions | All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Serve… |
...
| Project | Stars | Language | Stack | Description |
| --- | ---: | --- | --- | --- |
| [OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files) | 27,133 | Python | GitHub Actions | Persistent file-based planning for AI coding agents and long-running tasks. Crash-proof m… |
| [agentscope-ai/agentscope-java](https://github.com/agentscope-ai/agentscope-java) | 5,791 | Java | GitHub Actions | Build distributed, production-grade, long-running agents. |
...
| [everruns/everruns](https://github.com/everruns/everruns) | 50 | Rust | GitHub Actions, Tokio | Headless durable agentic harness engine. Run durable AI agents reliably and scalably. |
...
| Project | Stars | Language | Stack | Description |
| --- | ---: | --- | --- | --- |
| [CopilotKit/CopilotKit](https://github.com/CopilotKit/CopilotKit) | 37,552 | TypeScript | Express, GitHub Actions, MCP SDK, React | The Frontend Stack for Agents &amp; Generative UI. React, Angular, Mobile, Slack, and more.… |
| [ag-ui-protocol/ag-ui](https://github.com/ag-ui-protocol/ag-ui) | 16,050 | TypeScript | GitHub Actions | AG-UI: the Agent-User Interaction Protocol. Bring Agents into Frontend Applications. |
| [HarnessRouter/harnessrouter](https://github.com/HarnessRouter/harnessrouter) | 2,626 | Python | Docker, Docker Compose, GitHub Actions | HarnessRouter Community Edition: the self-hosted, Apache-2.0 edition of the unified inter… |
...
| [google/sam](https://github.com/google/sam) | 939 | Go | GitHub Actions | SAM |
...
| Project | Stars | Language | Stack | Description |
| --- | ---: | --- | --- | --- |
| [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 70,301 | TypeScript | Docker, Docker Compose, Express, GitHub Actions | Never stop coding. Free MIT AI gateway: one endpoint, 359 providers (150+ free), 1200+ mo… |
| [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) | 13,084 | TypeScript | Docker, GitHub Actions | A blazing fast AI Gateway with integrated guardrails. Route to 1,600+ LLMs, 50+ AI Guardr… |
